...
multBy5.power = 2 // function can also be used like an object 

console.log(multBy5(5)) // 25
...
// to give context to the increment function to let it know which object's value to increment we add 'this'
// So, this.score = this.score + 2
...
If no explicit return value is specified from the constructor, JavaScript assumes this, the newly 
...
doesn't return a non-primitive value (object, array, function, etc.), the newly created object is returned.
